...
- **Riemannian Bilevel Optimization.** *Journal of Machine Learning Research* \[[PDF](https://arxiv.org/pdf/2402.02019.pdf)\]
- **A Riemannian ADMM.** *Mathematics of Operations Research* \[[PDF](https://arxiv.org/pdf/2211.02163.pdf)\]
- **Zeroth-order Riemannian Averaging Stochastic Approximation Algorithms.** *SIAM Journal on Optimization* \[[PDF](https://arxiv.org/pdf/2309.14506.pdf)\]
- **Problem-Parameter-Free Decentralized Nonconvex Stochastic Optimization.** *Pacific Journal of Optimization* \[[PDF](https://arxiv.org/pdf/2402.08821)\]
- **Stochastic Zeroth-order Riemannian Derivative Estimation and Optimization.** *Mathematics of Operations Research* \[[PDF](https://arxiv.org/pdf/2003.11238.pdf)\]
- **Getting More Juice Out of the SFT Data: Reward Learning from Human Demonstration Improves SFT for LLM Alignment.** *NeurIPS 2024* \[[PDF](https://arxiv.org/pdf/2405.17888)\]
- **Revisiting zeroth-order optimization for memory-efficient llm fine-tuning: A benchmark.** *ICML 2024* \[[PDF](https://arxiv.org/pdf/2402.11592)\]
